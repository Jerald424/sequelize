...
export default function Header() {
    ...
    return (
      <nav
        class={`navbar navbar-expand-lg fixed-top ${isDark ? "navbar-dark bg-dark " : "navbar-light bg-light"}`}
        style={{
          boxShadow: `0.1px 0.1px 2px ${colors?.textSecondary}`,
          zIndex: 999,
        }}
      >
        <div class="container-fluid">
          <Hover color className="navbar-brand p-1 br-2 cp">
            Navbar
          </Hover>
